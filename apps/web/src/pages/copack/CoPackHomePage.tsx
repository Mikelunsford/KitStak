 ...
 * work tiles move to the shared StatCard / ActionTile components. The pillar
 * hero header keeps its landing-scale display type (it is a hero, not a list
 * header, so it stays larger than the kit PageHeader).
 */
