// sales-config-api local helpers. Same pattern as quotes-api/_helpers.ts and
// invoicing-api/_helpers.ts: thin wrapper that provides a sales-cap-aware
// requireCap. The capability set is held in _shared/capabilities/sales.ts
// (the byte-mirrored side-car canon); the org-cap set in
// _shared/capabilities.ts is left undisturbed.
